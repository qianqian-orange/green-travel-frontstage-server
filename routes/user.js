...
router.post('/conversion/remove', (req, res) => {
  userController.conversionRemove(req, res);
});

router.get('/conversion/detail', (req, res) => {
  userController.conversionDetail(req, res);
});
